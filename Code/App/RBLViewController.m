...
@property (weak, nonatomic) IBOutlet UIImageView *_changeableImageView;


@end

static RBLViewController* Object;
...
-(void)loadImage
{
    ...
    __changeableImageView.image=[UIImage imageNamed:[imageArray objectAtIndex:image]];
...
- (void)viewDidLoad
{
    ...
    __changeableImageView.image=[UIImage imageNamed:@"program.jpg"];
    imageArray=[[NSMutableArray   alloc]initWithObjects:@"Oscar_1.jpg",@"Oscar_2.jpg",@"Oscar_3.jpg", @"Oscar_4.jpg", nil];
    NSTimer *imageTimer = [NSTimer scheduledTimerWithTimeInterval: 0.5 target:self selector:@selector(loadImage) userInfo:nil repeats: YES];
